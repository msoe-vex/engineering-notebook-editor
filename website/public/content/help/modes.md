...
The Engineering Notebook Editor supports three distinct ways to manage your data. Choose the one that best fits your team's workflow.
...
Everything is saved in your browser's database (IndexedDB). No setup or folders needed, but the data is tied to your browser and can be lost if you clear your site data.
