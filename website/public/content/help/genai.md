...
5. Type a **model id**, or use the search icon to pick from the list loaded for that key. The list is filtered to models that can take **text and images** (needed for figure captions). Generation warns if no model is set.
